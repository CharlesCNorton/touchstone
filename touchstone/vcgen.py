...
# --------------------------------------------------------------------------- #
# Re-checkable reproducibility bundles (folded in from certificate.py).             #
# --------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------- #
# SMTCoq obligation export (folded in from smtcoq_export.py).                       #
# --------------------------------------------------------------------------- #
...
_HEADER = (
    "(* GENERATED from the engine's actual integer obligations by touchstone.vcgen.\n"
    "   Each goal is a refutation query the engine discharged as PROVED; SMTCoq re-checks the veriT\n"
    "   certificate in Coq's kernel. Regenerate: python -m touchstone.vcgen proofs/touchstone_obligations.v *)\n"
...
__all__ = [
    ...
    "proof_bundle", "recheck_bundle",                                                   # folded in from certificate
    "obligation_to_coq", "collect_obligations", "generate_obligation_lemmas", "write_obligation_proofs",   # smtcoq
]


if __name__ == "__main__":                                  # regenerate proofs/touchstone_obligations.v (was smtcoq_export)
    import sys
